...
## Goals
The aim of this project is to design, develop, and validate a comprehensive IoT Security Assessment System capable of analyzing the security of consumer IoT devices across three critical dimensions: 

- **Network traffic analysis**
- **Web and API behaviour assessment**
- **Firmware extraction and static analysis** 

Achieving this aim requires not only the development of appropriate technical tools and methods but also a structured workflow that integrates findings across all layers to produce meaningful, actionable security insights. 
